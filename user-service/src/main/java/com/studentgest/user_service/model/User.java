...
public class User {
    ...
    public Boolean isRequiresPasswordChange() {
        return requiresPasswordChange != null ? requiresPasswordChange : false;
    }
    ...
    public String getEstadoGmail() {
        return estadoGmail;
    }

    public void setEstadoGmail(String estadoGmail) {
        this.estadoGmail = estadoGmail;
    }
    ...
    public Timestamp getExpiracionTokenVerificacion() {
        return expiracionTokenVerificacion;
    }
